                ...
                {profileDropdownOpen && (
                  ...
                  >
                    ...
                    <div className="flex gap-3">
                      <button
                        className={`flex-1 flex items-center justify-center gap-1 px-2 py-1 rounded-lg transition-colors text-xs ${
                          theme === "dark"
                            ? "bg-gray-600 hover:bg-gray-700 text-gray-100"
                            : "border-primary bg-gray-500 hover:bg-gray-50 text-white"
                        }`}
                      >
                        <BarChart3 size={16} />
                        Analytics Data
