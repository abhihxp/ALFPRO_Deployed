...
const MainLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="flex bg-[#F8F9FB] dark:bg-gray-900 min-h-screen relative text-gray-900 dark:text-gray-100">
      ...
      <div
        className={`flex-1 p-8 pt-0 transition-all duration-300 ${collapsed ? "ltr:ml-20 rtl:mr-20" : "ltr:ml-64 rtl:mr-64"
          } min-w-0`}
      >
        {/* Sticky Header */}
            ...
            <div className="relative">
              ...
              >
                <img
                  ...
                  alt="Profile"
                  className="w-10 h-10 object-contain p-1 rounded-full border-2 border-white dark:border-gray-700 shadow-sm"
                />
                ...
                >
                  <div className="flex items-center gap-4 mb-4">
                    <img
                      src="/assets/dark-mini.png"
                      alt="Profile"
                      className="w-16 h-16 object-contain p-1 rounded-full border-2 border-gray-200 dark:border-gray-600"
                    />
                    <div>
