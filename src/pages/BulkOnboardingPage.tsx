        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-8">
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
              {t("form.bulkOnboarding.title")}
            </h2>
            <p className="text-gray-500 dark:text-gray-400">
              {t("form.bulkOnboarding.label")}
            </p>
          </div>
          ...
          >
            <div className="grid grid-cols-12 gap-x-6 gap-y-6">
              ...
              <div className="col-span-12">
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-sm text-gray-600 dark:text-gray-300">
                    {t("form.bulkOnboarding.upload.label")}
                  </span>
                  <Button
                    type="link"
                  ...
                  >
                    {t("form.bulkOnboarding.upload.download")}
                  </Button>
                </div>
              </div>
              ...
              <div className="col-span-12 md:col-span-6 lg:col-span-6">
                <Form.Item
                  name="processingMode"
                  rules={[
                    { required: true, message: "Processing Mode is required" },
                  ]}
                  className="mb-0"
                >
                  <div className="relative">
                    <Select
                      ...
                      placeholder={
                        !showSelectPlaceholder ? undefined : undefined
                      } // We rely on custom overlay
                      allowClear
                    >
                      <Select.Option value="validate_only">
                        Validate Only
                      </Select.Option>
                      <Select.Option value="process_valid">
                        Process Valid Records
                      </Select.Option>
                      <Select.Option value="stop_on_error">
                        Stop on First Error
                      </Select.Option>
                    </Select>
                    {showSelectPlaceholder && (
                      <span className="absolute left-3 top-0 bottom-0 flex items-center text-gray-400 pointer-events-none z-10 select-none">
                        ...
                        <span className="text-gray-500 dark:text-gray-400">
                          {t("form.bulkOnboarding.upload.placeholder")}
                        </span>
                      </span>
                    )}
                  </div>
              ...
              <div className="col-span-12 md:col-span-6 lg:col-span-6">
                ...
                >
                  ...
                  >
                    <Button
                      icon={<UploadOutlined />}
                      className="w-full h-10 text-left flex items-center rounded-lg text-gray-500 border-gray-300 dark:border-gray-600 dark:bg-transparent dark:text-gray-300"
                    >
                      {!uploadFileValue?.fileList?.length ? (
                        <>
                          <span className="text-red-500 mr-1">*</span>
                          {t("form.bulkOnboarding.upload.button")}
                        </>
                      ) : (
                        "File Selected"
                      )}
            ...
            <div className="mt-8 flex justify-end gap-3">
              ...
              <Button onClick={handleClearAll} className="h-10 px-6">
