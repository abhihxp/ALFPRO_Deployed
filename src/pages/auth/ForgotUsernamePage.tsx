...
const ForgotUsernamePage = () => {
    ...
    const onFinish = (values: any) => {
        ...
        message.success('Username sent to your email.');
    };

    return (
        <AuthLayout title="Forgot Username" subtitle="Enter your email to recover your username">
            <Form
                name="forgot_username"
                className="forgot-username-form"
                onFinish={onFinish}
                layout="vertical"
            >
                <Form.Item
