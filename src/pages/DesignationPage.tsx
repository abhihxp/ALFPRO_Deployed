...
const DesignationPage = () => {
    ...
    const handleFinish = (values: any) => {
        console.log('Submitted Designation:', values);
    };
        ...
        <div className="w-full mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-8">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">{t('form.designation.title')}</h2>
                    <Button onClick={() => navigate(-1)}>{t('form.buttons.back')}</Button>
                </div>
                ...
                >
                    <DynamicForm schema={designationSchema} form={form} />
